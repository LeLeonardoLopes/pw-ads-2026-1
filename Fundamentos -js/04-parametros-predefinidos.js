...
// Chamando a função apenas dois parÂmetros 
console.log (`Área retângulo 20x40: ${calcArea(20,40)}`)

/*
    Regras para o uso dos parâmetros predefinidos
    1) O parâmetro predefinido deve vir sempre por último na lista de parÂmetros de uma função
    2) Pode haver mais de um parÂmetro predefinido. Nesse caso, devem ser sempre OS ULTIMOS.
*/
